...
setup_certbot() {
  ...
  echo "  certbot certonly --webroot -w /opt/hopehub/deploy/certbot/www -d api.hopehub.in -d hopehub.in -d care.hopehub.in -d admin.hopehub.in -d earn.hopehub.in -d doctor.hopehub.in -d ops.hopehub.in"
}
