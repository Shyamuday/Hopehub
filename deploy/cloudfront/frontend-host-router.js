...
function handler(event) {
  ...
  if (prefix === 'healing') {
    ...
    var prerenderedRoutes = {
      ...
      '/faq': true,
      '/careers': true,
      '/careers/tgadmin': true,
      '/careers/professional': true,
      '/careers/listener': true,
      '/careers/coach': true,
      '/careers/mental-wellness-professional': true,
      '/careers/qualified-counsellor': true,
      '/careers/psychology-student-listener': true,
      '/careers/peer-support-listener': true,
      '/careers/nlp-coach': true,
      '/careers/life-coach': true,
      '/careers/meditation-breathwork-guide': true,
      '/careers/career-study-mentor': true,
