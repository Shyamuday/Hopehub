/** Source snapshot for apps/web/data/clinical-diagnosis-taxonomy.json — edit JSON or this file, then run npm run build:clinical-diagnosis-taxonomy */

export const clinicalDiagnosisCategories = [
  {
    id: 'mental-disease',
    ...
    subSections: [
      {
        ...
        diseaseNames: [
          ...
          'Metabolic imbalance',
          'Long-standing unexplained symptoms'
        ]
      }
    ]
  }
