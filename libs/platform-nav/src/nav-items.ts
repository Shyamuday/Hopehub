...
export const OPERATIONS_NAV_ITEMS: PlatformNavItem[] = [
  ...
  {
    path: '/admin/ecosystem-users',
    label: 'Portal users',
    icon: '🌐',
    capability: 'admin.ecosystem_users'
  },
  ...
  { path: '/scan', label: 'Scan patient', icon: '📷', capability: 'patient.scan' },
  {
    ...
    label: 'Clinic hub',
    icon: '🏥',
    capability: 'clinic_manager.portal'
  },
  ...
  { path: '/lab-referrals', label: 'Lab referrals', icon: '🧪', capability: 'diagnostic.portal' },
  {
    ...
    icon: '🏢',
    capability: 'corporate_wellness.portal'
  },
  { path: '/claims', label: 'Insurance claims', icon: '📄', capability: 'insurance.portal' },
  {
    ...
    label: 'Store counter',
    icon: '🏪',
    capability: 'store_counter.portal'
  },
  ...
  {
    path: '/store/patients',
    label: 'Store patients',
    icon: '🪪',
    capability: 'store_counter.portal'
  },
  { path: '/store/medicines', label: 'Medicines', icon: '💊', capability: 'store_counter.portal' },
  { path: '/store/rack-map', label: 'Rack map', icon: '🗺️', capability: 'store_counter.portal' },
  { path: '/store/movements', label: 'Movements', icon: '📋', capability: 'store_counter.portal' },
  {
    path: '/store/staff-activity',
    label: 'Staff activity',
    icon: '👥',
    capability: 'store_counter.portal'
  },
  { path: '/store/staff-hr', label: 'Staff HR', icon: '🪪', capability: 'store_counter.portal' },
  { path: '/store/my-pay', label: 'My pay', icon: '💰', capability: 'store_counter.portal' },
  {
  ...
  },
  {
    ...
    label: 'Store manager',
    icon: '👔',
    capability: 'store_manager.portal'
  },
  {
    path: '/store-manager/search',
    label: 'Manager dispense',
    icon: '💊',
    capability: 'store_manager.portal'
  },
  {
    path: '/store-manager/purchase-orders',
    label: 'Incoming POs',
    icon: '📥',
    capability: 'store_manager.portal'
  },
  {
    path: '/store-manager/stock-transfers',
  ...
  {
    path: '/store-manager/medicines',
    label: 'Manager medicines',
    icon: '💊',
    capability: 'store_manager.portal'
  },
  {
    path: '/store-manager/rack-map',
    label: 'Manager rack map',
    icon: '🗺️',
    capability: 'store_manager.portal'
  },
  {
    path: '/store-manager/movements',
    label: 'Manager movements',
    icon: '📋',
    capability: 'store_manager.portal'
  },
  {
    path: '/store-manager/staff-activity',
    label: 'Manager staff activity',
    icon: '👥',
    capability: 'store_manager.portal'
  },
  {
    path: '/store-manager/staff-hr',
    label: 'Manager staff HR',
    icon: '🪪',
    capability: 'store_manager.portal'
  },
  {
    path: '/store-manager/store-expenses',
    label: 'Manager expenses',
    icon: '🧾',
    capability: 'store_manager.portal'
  },
  {
    path: '/store-manager/patients',
    label: 'Manager patients',
    icon: '🪪',
    capability: 'store_manager.portal'
  }
];
