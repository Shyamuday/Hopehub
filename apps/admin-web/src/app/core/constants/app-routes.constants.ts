...
export const NAV_ITEMS = [
  ...
  { path: adminNavPath(ROUTE_PATHS.LISTENER_SCREENING), label: '🧪 Listener Test' },
  { path: adminNavPath(ROUTE_PATHS.ASSESSMENT_DEFINITIONS), label: 'Assessments' },
  { path: adminNavPath(ROUTE_PATHS.PRACTICES), label: 'Practices' },
  { path: adminNavPath(ROUTE_PATHS.LIFESTYLE_TIPS), label: 'Lifestyle tips' },
  ...
  { path: adminNavPath(ROUTE_PATHS.TELEGRAM_BOTS), label: '🤖 Telegram Bots' },
