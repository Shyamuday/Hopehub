...
export const API_PATHS = {
  ...
  ADMIN: {
    ...
    AUTH_SESSION_REVOKE: (id: string) => `/admin/auth-sessions/${id}/revoke`,
    USER_AUTH_SESSIONS_REVOKE: (id: string) => `/admin/users/${id}/auth-sessions/revoke`,
    USERS: '/admin/users',
    ...
    TELEGRAM_GROUP_HELP_APPLY: '/admin/telegram-bots/group-help/apply',
