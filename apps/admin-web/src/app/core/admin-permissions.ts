...
export function adminHasAllPermissions(user: AdminUser | null | undefined, ...required: string[]): boolean {
...
export function adminHasAnyPermission(user: AdminUser | null | undefined, ...candidates: string[]): boolean {
  return candidates.some((c) => adminHasAllPermissions(user, c));
}
