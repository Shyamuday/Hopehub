...
export class NavigationService {
    ...
    private initializeNavigation(): void {
        ...
        this.router.events
            ...
            .subscribe(() => {
                ...
                this.updateNavigationState(this.getCurrentRoute(), { isNavigating: true, navigationError: null });
            });
    ...
    private updateNavigationState(currentUrl: string, partialUpdate?: Partial<NavigationState>): void {
    ...
    private updatePageMetadata(): void {
        ...
        let title = 'Healing Hub - Professional Mental Health Services';
        let description = 'Professional mental health services and community support';
        let keywords = 'mental health, counseling, therapy, healing hub';
    ...
    getBreadcrumbs(): BreadcrumbItem[] {
        ...
        for (let i = 0; i < segments.length; i++) {
            ...
            const routeConfig = this.router.config.find(r => r.path === segments.slice(0, i + 1).join('/'));
