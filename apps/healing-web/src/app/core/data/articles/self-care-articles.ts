...
export const SELF_CARE_ARTICLES: Article[] = [
  {
    ...
    description:
      'Learn how to build a personalized self-care routine that fits your lifestyle and supports your mental health.',
    ...
    introduction:
      "Self-care isn't selfish – it's essential for maintaining good mental health and overall well-being. This guide will help you understand what self-care really means and how to create a sustainable routine that works for your life.",

    sections: [
      {
        heading: 'What Is Self-Care?',
        content:
          "Self-care is the practice of taking deliberate actions to care for your physical, mental, and emotional health. It's about maintaining your well-being, not just treating problems after they arise.",
        type: 'text',
      },
      {
      ...
      },
      {
        ...
        content:
          'Identify areas where you need more support. What aspects of your well-being need attention?',
        type: 'tip',
      },
      {
        heading: 'Step 2: Start Small',
        content:
          'Choose 1-2 simple self-care activities you can realistically do regularly. Build consistency before adding more.',
        type: 'tip',
      },
      {
        heading: 'Step 3: Schedule It',
        content:
          'Treat self-care like any other important appointment. Put it in your calendar and protect that time.',
        type: 'tip',
      },
      {
        heading: 'Step 4: Make It Enjoyable',
        content:
          'Self-care should feel good, not like another chore. Choose activities you genuinely enjoy.',
        type: 'tip',
      },
      {
      ...
      },
      {
        ...
        content:
          'FACT: Many effective self-care activities are free, like walking, deep breathing, or calling a friend.',
        type: 'text',
      },
      {
        heading: 'Myth: Self-care takes too much time',
        content:
          "FACT: Even 5-10 minutes of self-care can make a difference. It's about consistency, not duration.",
        type: 'text',
      },
    ],
    ...
    conclusion:
      "Remember, self-care is not a one-size-fits-all solution. What works for others might not work for you, and that's okay. The key is to experiment, find what feels good and sustainable for your lifestyle, and make it a regular part of your routine.",
...

  {
    ...
    description:
      'Discover how to establish healthy boundaries in relationships, work, and personal life to protect your well-being.',
    type: ArticleType.GUIDE,
    ...
    introduction:
      'Healthy boundaries are essential for maintaining good mental health and positive relationships. They help you protect your energy, time, and emotional well-being while still maintaining meaningful connections with others.',

    sections: [
      {
        heading: 'What Are Healthy Boundaries?',
        content:
          "Boundaries are guidelines that define how you want to be treated and what you're comfortable with in relationships. They're not walls that keep people out, but rather guidelines that help create healthy interactions.",
        type: 'text',
      },
      {
      ...
      },
      {
        ...
        content:
          'Related to your body, personal space, and physical comfort. This includes who can touch you, how, and when.',
        type: 'text',
      },
      {
        heading: 'Emotional Boundaries',
        content:
          "Protecting your emotional well-being by limiting how much you take on others' emotions and problems.",
        type: 'text',
      },
      {
        heading: 'Time Boundaries',
        content:
          'Managing how you spend your time and protecting time for yourself and your priorities.',
        type: 'text',
      },
      {
      ...
      },
      {
        ...
        content:
          'Reflect on what makes you uncomfortable, stressed, or resentful. These feelings often indicate where boundaries are needed.',
        type: 'tip',
      },
      {
        heading: '2. Start Small',
        content:
          'Begin with less challenging situations and people who are more likely to respect your boundaries.',
        type: 'tip',
      },
      {
        heading: '3. Be Clear and Direct',
        content:
          'Use "I" statements to communicate your boundaries clearly: "I need some time to myself this evening."',
        type: 'tip',
      },
      {
        heading: '4. Be Consistent',
        content:
          'Maintain your boundaries consistently. Mixed messages make it harder for others to respect your limits.',
        type: 'tip',
      },
      {
        heading: '5. Prepare for Pushback',
        content:
          'Some people may resist your new boundaries. Stay firm and remember that their reaction is not your responsibility.',
        type: 'warning',
      },
    ],
