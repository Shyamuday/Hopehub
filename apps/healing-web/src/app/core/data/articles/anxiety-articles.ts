...
export const ANXIETY_ARTICLES: Article[] = [
  {
    ...
    introduction:
      'Anxiety is a normal human emotion, but when it becomes excessive and interferes with daily life, it may be an anxiety disorder. Understanding the different types of anxiety disorders and their symptoms is the first step toward getting help.',

    sections: [
      {
        heading: 'What Are Anxiety Disorders?',
        content:
          'Anxiety disorders are a group of mental health conditions characterized by excessive fear, worry, and related behavioral disturbances. They are the most common mental health disorders, affecting millions of people worldwide.',
        type: 'text',
      },
      {
      ...
      },
      {
        ...
        content:
          "Characterized by persistent, excessive worry about various aspects of life, even when there's little reason to worry.",
        type: 'text',
      },
      {
        heading: 'Panic Disorder',
        content:
          'Involves recurrent panic attacks - sudden episodes of intense fear accompanied by physical symptoms like rapid heartbeat, sweating, and shortness of breath.',
        type: 'text',
      },
      {
        heading: 'Social Anxiety Disorder',
        content:
          'Intense fear of social situations due to concerns about being judged, embarrassed, or humiliated by others.',
        type: 'text',
      },
      {
        heading: 'Specific Phobias',
        content:
          'Intense, irrational fear of specific objects or situations, such as heights, flying, or spiders.',
        type: 'text',
      },
      {
      ...
      },
      {
        ...
        content:
          "Consider seeking professional help if anxiety is interfering with your work, relationships, or daily activities, or if you're avoiding situations due to anxiety.",
        type: 'tip',
      },
      {
        heading: 'Treatment Options',
        content:
          'Anxiety disorders are highly treatable. Common treatments include cognitive-behavioral therapy (CBT), exposure therapy, medication, and lifestyle changes.',
        type: 'text',
      },
    ],
    ...
    conclusion:
      "If you're struggling with anxiety, remember that you're not alone and help is available. Anxiety disorders are among the most treatable mental health conditions, and with proper support, you can learn to manage your symptoms and live a fulfilling life.",
...

  {
    ...
    description:
      'Learn effective strategies to manage panic attacks in the moment and prevent them from controlling your life.',
    ...
    introduction:
      'Panic attacks can be terrifying experiences, but understanding what they are and having strategies to manage them can significantly reduce their impact on your life.',
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          'Tell yourself: "This is a panic attack. It will pass. I am safe. This feeling is temporary."',
        type: 'tip',
      },
      {
      ...
      },
      {
        ...
        content:
          'Physical activity helps reduce overall anxiety levels and can prevent panic attacks.',
        type: 'text',
      },
      {
        heading: 'Avoid Triggers',
        content:
          'Identify and limit caffeine, alcohol, and other substances that might trigger attacks.',
        type: 'text',
      },
      {
        heading: 'Practice Relaxation',
        content:
          'Regular meditation, yoga, or progressive muscle relaxation can help manage overall anxiety.',
        type: 'text',
      },
      {
        heading: 'When to Seek Professional Help',
        content:
          'If panic attacks are frequent, severe, or interfering with your life, professional treatment can be very effective.',
        type: 'warning',
      },
    ],
...

  {
    ...
    description:
      'Learn practical strategies to manage social anxiety and feel more comfortable in social situations.',
    type: ArticleType.SELF_HELP,
    ...
    introduction:
      'Social anxiety can make everyday interactions feel overwhelming, but with the right strategies, you can build confidence and enjoy social connections.',

    sections: [
      {
        heading: 'Understanding Social Anxiety',
        content:
          "Social anxiety involves intense fear of being judged, embarrassed, or rejected in social situations. It's more than just shyness - it can significantly impact daily life.",
        type: 'text',
      },
      {
        heading: 'Start Small',
        content:
          'Begin with low-stakes social interactions like greeting a cashier or making small talk with a neighbor.',
        type: 'tip',
      },
      {
      ...
      },
      {
        ...
        content:
          'Question anxious thoughts: "What\'s the worst that could really happen?" Often, our fears are much worse than reality.',
        type: 'text',
      },
      {
        heading: 'Focus on Others',
        content:
          'Shift attention away from yourself by asking questions and showing genuine interest in others. This reduces self-consciousness.',
        type: 'text',
      },
      {
        heading: 'Practice Self-Compassion',
        content:
          "Be kind to yourself when social interactions don't go perfectly. Everyone has awkward moments.",
        type: 'text',
      },
      {
        heading: 'Gradual Exposure',
        content:
          'Gradually expose yourself to increasingly challenging social situations. Start with what feels manageable and work your way up.',
        type: 'text',
      },
    ],
