...
export const routes: Routes = [
    ...
    },
    {
        ...
        data: {
            ...
            keywords: 'mental health services, counseling, therapy, breakup counseling, career counseling'
        }
    },
    {
        path: 'services/:id',
    ...
    {
        path: 'exercises',
        loadComponent: () => import('./shared/components/exercises/exercises.component').then(m => m.ExercisesComponent),
        title: 'Mental Health Exercises - Healing Hub',
        data: {
            breadcrumb: 'Exercises',
            description: 'Evidence-based mental health exercises for anxiety, depression, stress and well-being',
            keywords: 'mental health exercises, breathing, mindfulness, anxiety relief, stress management'
        }
    },
    {
        path: 'assessments',
        loadComponent: () => import('./shared/components/multi-assessment/multi-assessment.component').then(m => m.MultiAssessmentComponent),
        title: 'Mental Health Assessments - Healing Hub',
        data: {
            breadcrumb: 'Assessments',
            description: 'Comprehensive mental health assessments including PHQ-9, GAD-7, and other validated tools',
            keywords: 'mental health assessment, PHQ-9, GAD-7, depression screening, anxiety assessment'
        }
    },
    {
        path: 'lifestyle-tips',
        loadComponent: () => import('./shared/components/lifestyle-tips/lifestyle-tips.component').then(m => m.LifestyleTipsComponent),
        title: 'Lifestyle Tips for Mental Wellness - Healing Hub',
        data: {
            breadcrumb: 'Lifestyle Tips',
            description: 'Evidence-based lifestyle tips for improving mental health, sleep, nutrition, and well-being',
            keywords: 'lifestyle tips, mental wellness, sleep hygiene, nutrition, stress management, work-life balance'
        }
    },
    {
        path: 'articles',
        loadComponent: () => import('./shared/components/articles/articles.component').then(m => m.ArticlesComponent),
        title: 'Mental Health Articles & Resources - Healing Hub',
        data: {
            breadcrumb: 'Articles',
            description: 'Evidence-based articles and resources for understanding and improving mental health',
            keywords: 'mental health articles, depression, anxiety, stress, self-care, psychology resources'
        }
    },
    {
        path: '404',
