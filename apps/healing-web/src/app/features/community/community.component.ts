    ...
    <div class="min-h-screen bg-[var(--brand-surface)]">
      <div class="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div class="mx-auto mb-7 max-w-3xl text-center">
          <span class="hope-chip mb-3">Join in one step</span>
          <h1 class="mb-2 text-2xl font-semibold text-gray-950 sm:text-3xl">
            Choose your community
          </h1>
          <p class="text-sm leading-6 text-gray-700 sm:text-base">
            On your phone, tap Join. On a computer, scan the visible QR code—nothing else to open.
          </p>
        </div>
        ...
        <div class="mb-6 grid grid-cols-1 gap-5 lg:grid-cols-2">
          <!-- Telegram Card -->
          <div
            class="hope-motion-card flex h-full flex-col overflow-hidden rounded-2xl border border-sky-200 bg-white text-gray-800 shadow-sm"
          >
            <div class="border-b border-sky-100 bg-sky-50/70 p-5 sm:p-6">
              <div class="flex items-start gap-4">
                <span
                  class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-sky-600 text-white shadow-sm"
                  aria-hidden="true"
                >
                ...
                <div>
                  <span class="hope-chip mb-2">Recommended</span>
                  <h2 class="text-xl font-semibold text-gray-950">Telegram community</h2>
            ...
            <div
              class="grid flex-1 gap-5 p-5 sm:p-6 sm:grid-cols-[minmax(0,1fr)_12rem] sm:items-center"
            >
              <div>
                <p class="text-xs font-bold uppercase tracking-wide text-sky-700">On this device</p>
                <p class="mb-4 mt-1 text-sm leading-6 text-gray-600">
                  Open Telegram directly and join the community.
                </p>
                <app-button
                  [href]="APP_CONSTANTS.TELEGRAM.GROUP_URL"
                  target="_blank"
                  rel="noopener noreferrer"
                  ariaLabel="Join the Hope Hub Telegram community"
                  block
                >
                  ...
                  Join {{ APP_CONSTANTS.TELEGRAM.SUPPORT_HANDLE || 'on Telegram' }}
                </app-button>
                <p class="mt-3 text-xs leading-5 text-gray-500">
                  Telegram privacy depends on your own profile settings.
                </p>
              </div>

              <div
                class="rounded-xl border border-sky-200 bg-sky-50 p-3 text-center"
                data-testid="telegram-qr-panel"
              >
                <p class="text-xs font-bold uppercase tracking-wide text-sky-800">Scan to join</p>
                <div
                  class="mx-auto mt-2 w-fit rounded-lg bg-white p-2 shadow-sm ring-1 ring-sky-100"
                >
                  <img
                    [src]="APP_CONSTANTS.TELEGRAM.QR_CODE"
                    [alt]="
                      'Scan to join ' +
                      (APP_CONSTANTS.TELEGRAM.SUPPORT_HANDLE || 'Hope Hub') +
                      ' on Telegram'
                    "
                    width="160"
                    height="160"
                ...
                <p class="mt-2 text-xs leading-5 text-sky-900">Point your phone camera here</p>
              </div>
            </div>
          </div>
          ...
          <!-- WhatsApp Card -->
          <div
            class="hope-motion-card flex h-full flex-col overflow-hidden rounded-2xl border border-emerald-200 bg-white text-gray-800 shadow-sm"
          >
            <div class="border-b border-emerald-100 bg-emerald-50/70 p-5 sm:p-6">
              <div class="flex items-start gap-4">
                ...
                <div>
                  <h2 class="text-xl font-semibold text-gray-950">WhatsApp updates</h2>
                  <p class="mt-1 text-sm leading-6 text-gray-700">
                    Get community reminders and important Hope Hub updates.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <p class="mb-4 mt-1 text-sm leading-6 text-gray-600">
                  Open WhatsApp directly and join the updates group.
                </p>
                <app-button
                  [href]="APP_CONSTANTS.WHATSAPP.GROUP_URL"
                  target="_blank"
                  rel="noopener noreferrer"
                  ariaLabel="Join the Hope Hub WhatsApp updates group"
                  block
                >
                  <svg class="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                    <path
                ...
                <p class="mt-3 text-xs leading-5 text-amber-700">
                  Your phone number may be visible to other group members.
                </p>
              </div>

              <div
                class="rounded-xl border border-emerald-200 bg-emerald-50 p-3 text-center"
              ...
              >
                ...
                <div
                  class="mx-auto mt-2 w-fit rounded-lg bg-white p-2 shadow-sm ring-1 ring-emerald-100"
                >
                  <img
                    [src]="APP_CONSTANTS.WHATSAPP.QR_CODE"
                    alt="Scan to join the Hope Hub WhatsApp updates group"
                    width="160"
                    height="160"
                    loading="eager"
                    class="h-40 w-40 object-contain"
                ...
                <p class="mt-2 text-xs leading-5 text-emerald-900">Point your phone camera here</p>
              </div>
            </div>
          </div>
        </div>
