...
export const chronicCareDiseaseInfo: DiseaseInfo = {
  ...
  ourApproach: {
    ...
    intro:
      'Chronic symptoms often have a pattern across sleep, stress, appetite, weather, past illness, family tendency, and emotional state. Our provider-led approach focuses on the whole case, not only the current complaint.',
    points: [
  ...
  causes: [
    ...
    'Previous illness or treatment history',
  ],
  riskFactors: [
  ...
  diagnosis:
    'Chronic care starts with detailed history. The provider may ask for previous reports, prescriptions, symptom timeline, and trigger patterns.',
  tests: [
    'Depends on symptoms and previous reports',
    'Provider may request offline tests if needed',
  ],
  treatmentOptions: {
    allopathy:
      'Existing allopathic treatment should not be stopped without treating clinician advice.',
    ayurveda: 'Supportive lifestyle practices may be discussed where appropriate.',
    homeopathy:
      'Homeopathy may be considered as one care option based on total symptom pattern and chronic tendency.',
    lifestyle: 'Sleep, stress, diet, routine, and trigger tracking are often important.',
  },
  medications: [
    'Depends on condition and provider review',
    'Do not stop current medicines without medical advice',
  ],
  ...
  severityLevel:
    'Chronic stable cases can be reviewed online; acute worsening needs offline medical care.',
  whenToSeeDoctor:
    'Consult when symptoms recur, persist, affect daily life, or remain unexplained despite previous care.',
  emergencySigns: [
    'Chest pain',
  ...
  faq: [
    {
      ...
      answer:
        'Online care can support detailed history review, pattern analysis, and follow-up for many chronic and rare cases. Some cases may require offline examination or specific tests that cannot be done remotely. The provider will guide you on what can be managed online and when an in-person visit is needed.',
    },
    {
      question: 'Should I stop my current medicines before starting homeopathic treatment?',
      answer:
        'No. Never stop existing medicines without the advice of your treating clinician. Homeopathy or other supportive care can be discussed alongside current medications in many cases. The provider will review your current treatment and advise on any next steps based on your response.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Bring a timeline of your symptoms - when they started, what makes them better or worse, what treatments you have tried, and how you responded. Previous reports, prescriptions, and test results are very helpful. The more complete your history, the better the provider can understand your case.',
    },
    {
  ...
  references: [
    'Patient history',
    'Previous medical records when shared',
    'Provider consultation review',
  ],
  careApproach: [
    'Listen deeply to the full case history',
    'Track triggers, timing, recurrence, and response',
    'Create a care plan with follow-up',
    'Use low-medicine support where suitable',
  ],
  details: [
    'Chronic cases need continuity and structured notes.',
    'The provider may ask about sleep, stress, appetite, past illness, family tendency, and previous treatments.',
