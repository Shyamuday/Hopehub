...
export const LEGAL_PAGES = {
  privacy: {
    ...
    intro:
      `${CLINIC_NAME} respects your privacy. This policy explains what personal and health information we collect when you use our website, patient app, consultations, chat, prescriptions, and medicine orders — and how we use it to deliver care.`,
    ...
    sections: [
      ...
      {
        title: 'Contact',
        paragraphs: [`For privacy-related questions, email ${CONTACT_EMAIL} or contact us through WhatsApp support on the website.`]
      }
    ]
  },
  terms: {
    ...
    sections: [
      ...
      {
        title: 'Governing law',
        paragraphs: [`These terms are governed by the laws of ${GOVERNING_LAW}. Disputes shall be subject to the courts at Ranchi, Jharkhand, unless otherwise required by law.`]
      },
      {
        title: 'Contact',
  ...
  returnExchange: {
    ...
    sections: [
      ...
      {
        title: 'Contact',
        paragraphs: [`Report order issues at ${CONTACT_EMAIL} or via WhatsApp support with your order number.`]
      }
    ]
  },
  shipping: {
