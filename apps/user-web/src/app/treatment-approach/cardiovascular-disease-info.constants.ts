...
export const cardiovascularDiseaseInfo: DiseaseInfo = {
  ...
  causes: [
    ...
    'Lifestyle and obesity-related factors',
  ],
  riskFactors: [
    'Obesity',
  ...
  diagnosis:
    'Clinical assessment is based on symptom history, risk profile, previous records, and provider review. Offline investigations can be advised when required.',
  tests: [
    'Lipid profile',
    'Blood sugar panel',
    'ECG / Echo as advised',
    'Kidney and liver function tests when relevant',
  ],
  treatmentOptions: {
    ...
    lifestyle:
      'Weight management, activity correction, sleep improvement, and nutrition planning are key.',
  },
  homeCare: [
    'Track BP and weight regularly',
    'Follow a low-salt and balanced diet',
    'Avoid smoking and alcohol excess',
  ],
  prevention: [
    'Routine lipid and sugar screening',
    'Physical activity',
    'Early intervention for obesity and BP issues',
  ],
  severityLevel:
    'Stable chronic cases can be guided online; acute chest pain or sudden breathlessness needs emergency offline care.',
  whenToSeeDoctor:
    'Consult early for recurrent chest symptoms, low exercise tolerance, high BP history, or known lipid abnormalities.',
  emergencySigns: [
    'Severe chest pain',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'General targets: LDL (bad cholesterol) below 100 mg/dL for most adults, below 70 mg/dL for those with existing heart disease or high risk. HDL (good cholesterol) above 40 mg/dL for men and above 50 mg/dL for women. Triglycerides below 150 mg/dL. Your provider or treating clinician will set personalized targets based on your overall cardiovascular risk.',
    },
    {
