...
export const musculoskeletalDiseaseInfo: DiseaseInfo = {
  ...
  symptoms: [
    ...
    'Reduced mobility',
    'Back or neck pain',
    'Morning stiffness and activity limitation',
  ],
  causes: [
  ...
  tests: [
    'X-ray / MRI when indicated',
    'Inflammatory markers in selected cases',
    'Vitamin D and calcium profile where relevant',
  ],
  treatmentOptions: {
    allopathy:
      'May include pain and inflammation control, physiotherapy guidance, and specialist referral.',
    homeopathy: 'Can be considered as adjunct chronic symptom care where suitable.',
    lifestyle:
      'Posture correction, supervised activity, weight control, and ergonomic changes are important.',
  },
  homeCare: [
    'Daily mobility exercises',
    'Joint protection techniques',
    'Heat/cold measures where suitable',
  ],
  prevention: [
    'Regular activity',
    'Fall prevention in elderly',
    'Weight management',
    'Early attention to persistent pain',
  ],
  severityLevel:
    'Mild to moderate chronic symptoms are suitable for planned online guidance; severe acute pain or trauma needs in-person care.',
  whenToSeeDoctor:
    'Consult when pain persists, daily activities reduce, swelling recurs, or stiffness progressively worsens.',
  emergencySigns: [
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Exercise is one of the most effective treatments for most musculoskeletal conditions. Strengthening muscles around a joint reduces load on the joint itself. Low-impact activities like walking, swimming, and cycling are generally well-tolerated. Complete rest often worsens stiffness and muscle weakness. Your provider or physiotherapist will guide appropriate activity levels.',
    },
    {
