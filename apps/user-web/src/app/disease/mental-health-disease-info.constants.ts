...
export const mentalHealthDiseaseInfo: DiseaseInfo = {
  ...
  about:
    'Supportive care for common mental health concerns such as anxiety, stress-related disorders, and depression.',
  summary:
  ...
  treatmentOptions: {
    ...
    lifestyle:
      'Counseling, routine stabilization, sleep hygiene, and stress management are essential.',
  },
  homeCare: [
    'Maintain sleep routine',
    'Reduce social isolation',
    'Practice daily stress-regulation strategies',
  ],
  prevention: [
    'Early screening',
    'Timely counseling',
  ...
  severityLevel:
    'Mild to moderate conditions can often be managed with planned follow-up; severe risk states need urgent in-person intervention.',
  whenToSeeDoctor:
    'Consult if symptoms persist beyond 2-3 weeks, worsen functioning, or affect personal safety.',
  emergencySigns: [
    'Suicidal thoughts',
    'Self-harm risk',
    'Severe confusion',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Yes. All consultations are confidential. Mental health concerns are treated with the same privacy as any other medical condition. You can share your history openly - your provider will not share your information without your consent.',
    },
    {
