...
export const chronicKidneyDiseaseInfo: DiseaseInfo = {
  ...
  icdCode: 'N18 group',
  about:
    'Long-term kidney health support, especially in patients with diabetes or hypertension history.',
  summary:
  ...
  causes: [
    ...
    'Glomerular disease',
    'Drug or toxin-related kidney injury',
  ],
  ...
  tests: [
    ...
    'Electrolyte panel',
    'Renal ultrasound where indicated',
  ],
  treatmentOptions: {
    allopathy:
      'Nephrology-directed management is often required to slow progression and manage complications.',
    homeopathy:
      'May be considered only as supportive adjunct care in stable, specialist-supervised chronic settings.',
    lifestyle:
      'BP/sugar optimization, diet moderation, fluid advice, and medication safety counseling are central.',
  },
  homeCare: [
    'Track BP and sugar regularly',
    'Follow kidney-friendly diet as advised',
    'Avoid self-medication, especially painkillers',
  ],
  prevention: [
    'Early diabetes/BP control',
    'Routine kidney screening in high-risk adults',
    'Prompt treatment of urinary and metabolic issues',
  ],
  severityLevel:
    'Stable CKD follow-up may be coordinated online; rapidly worsening kidney status needs urgent specialist offline care.',
  whenToSeeDoctor:
    'Consult for edema, persistent fatigue, poor urine output, rising creatinine, or uncontrolled diabetes/hypertension.',
  emergencySigns: [
    'Breathlessness with swelling',
    'Very low urine output',
    'Altered sensorium',
    'Severe electrolyte-related symptoms',
  ],
  faq: [
    {
    ...
    },
    {
      ...
      answer:
        'Dietary restrictions depend on your CKD stage and lab values. Common advice includes limiting high-potassium foods (bananas, oranges, potatoes), high-phosphorus foods (dairy, nuts, cola drinks), and excess protein. Your provider will guide specific restrictions based on your blood reports.',
    },
    {
