...
export const liverCirrhosisDiseaseInfo: DiseaseInfo = {
  ...
  causes: [
    ...
    'Autoimmune or metabolic liver disease',
  ],
  riskFactors: [
    'Alcohol misuse',
    'Chronic hepatitis',
  ...
  homeCare: [
    ...
    'Follow low-salt plan when advised',
    'Track swelling and weight changes',
  ],
  prevention: [
    'Early fatty liver management',
    'Hepatitis prevention/treatment',
    'Metabolic risk control',
  ],
  severityLevel:
    'Stable follow-up can be coordinated online; decompensated symptoms need urgent in-person care.',
  whenToSeeDoctor:
    'Consult urgently for increasing swelling, jaundice, confusion, GI bleeding signs, or appetite decline.',
  emergencySigns: [
    'Vomiting blood',
    'Black stools',
    'Confusion/drowsiness',
    'Breathing difficulty from fluid overload',
  ],
  faq: [
    {
    ...
    },
    {
      ...
      answer:
        'Avoid alcohol completely — even small amounts accelerate damage. Eat adequate protein (unless your provider advises restriction for encephalopathy risk). Reduce salt if you have ascites (abdominal fluid). Eat small, frequent meals. Avoid raw shellfish and unpasteurized foods due to infection risk. Your provider will tailor dietary advice to your stage.',
    },
    {
