...
export const gallstoneDiseaseInfo: DiseaseInfo = {
  ...
  symptoms: [
    ...
    'Nausea or bloating',
    'Episodes of severe abdominal discomfort',
  ],
  ...
  diagnosis:
    'Diagnosis is based on symptom pattern and imaging, usually ultrasound, along with clinical review.',
  tests: ['Abdominal ultrasound', 'Liver function tests', 'CBC where infection is suspected'],
  treatmentOptions: {
    allopathy:
      'Pain control and surgical referral may be needed in recurrent or complicated cases.',
  ...
  severityLevel:
    'Stable symptom cases can be evaluated online, but acute severe pain needs urgent offline review.',
  whenToSeeDoctor:
    'Consult if pain recurs, worsens, or is associated with fever, vomiting, or jaundice.',
  emergencySigns: [
  ...
  faq: [
    {
      ...
      answer:
        'No. Silent gallstones (found incidentally with no symptoms) often do not need immediate surgery and can be monitored. Surgery is recommended when stones cause recurrent pain, acute cholecystitis, biliary obstruction, or pancreatitis. Your provider will assess symptom burden and imaging to guide the decision.',
    },
    {
