...
export const hypertensionDiseaseInfo: DiseaseInfo = {
  ...
  symptoms: [
    ...
    'Dizziness',
    'Palpitations or fatigue in uncontrolled cases',
  ],
  causes: [
    'Primary (essential) hypertension',
    'Kidney or endocrine causes in select patients',
    'Dietary sodium excess and stress',
  ],
  riskFactors: [
    'Family history',
    'High salt intake',
  ...
  diagnosis:
    'Diagnosis is based on repeated BP measurements and risk profiling, along with comorbidity review.',
  tests: [
    'Serial BP charting',
  ...
  treatmentOptions: {
    ...
    lifestyle:
      'Salt reduction, stress management, exercise, sleep correction, and weight control are critical.',
  },
  homeCare: [
    'Maintain BP log',
    'Reduce salt intake',
    'Adhere to fixed medicine schedule',
    'Avoid missed doses',
  ],
  prevention: [
    'Routine screening after adulthood',
    'Early treatment of elevated BP',
    'Control obesity and metabolic risk',
  ],
  severityLevel:
    'Routine chronic management can be followed online; hypertensive urgency or emergency requires immediate offline care.',
  whenToSeeDoctor:
    'Consult for repeatedly elevated readings, medicine side effects, or uncontrolled BP despite treatment.',
  emergencySigns: [
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'No. Normal readings on medication mean the treatment is working, not that hypertension is gone. Stopping medicines without clinician guidance almost always leads to BP rising again. Any change to your medication should only be made in consultation with your provider or treating clinician.',
    },
    {
