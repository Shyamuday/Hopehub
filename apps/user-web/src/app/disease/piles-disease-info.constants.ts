...
export const pilesDiseaseInfo: DiseaseInfo = {
  ...
  diagnosis:
    'Diagnosis is based on symptom history and anorectal examination by a qualified clinician.',
  tests: [
    'Usually clinical diagnosis',
    'Proctoscopy in selected cases',
    'Additional GI evaluation if red flags are present',
  ],
  treatmentOptions: {
    allopathy:
      'Medical therapy and procedural/surgical options may be needed based on grade and severity.',
    homeopathy: 'May be considered as supportive symptom care in selected non-emergency cases.',
    lifestyle:
      'Fiber-rich diet, hydration, bowel habit correction, and avoiding prolonged straining are important.',
  },
  ...
  severityLevel:
    'Mild to moderate cases can be guided online; heavy bleeding or severe pain needs urgent in-person care.',
  whenToSeeDoctor:
    'Consult for recurrent bleeding, painful swelling, persistent symptoms, or suspected fissure/fistula overlap.',
