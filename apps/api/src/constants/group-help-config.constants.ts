...
export const HOPEHUB_COMMUNITY_LIVE_VOICE_IMAGE_URL =
...
const GROUP_HELP_CORE_CONFIG_FIELDS: GroupHelpConfigField[] = [
  ...
  {
    key: 'telegramGroupHelpLiveVoiceImageUrl',
    label: 'Live VC image URL',
    description:
      'Optional public image shown on active voice-chat announcements and recurring Join VC reminders.',
    section: 'messages',
    type: 'text',
    maxLength: 1000,
    placeholder: 'https://...',
    defaultValue: HOPEHUB_COMMUNITY_LIVE_VOICE_IMAGE_URL
  },
  {
