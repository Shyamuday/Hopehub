...
export const commandMenus: Record<TelegramBotKind, { command: string; description: string }[]> = {
  ...
  [TelegramBotKind.DOCTOR]: [
    ...
    { command: 'dashboard', description: 'Today’s provider overview' },
    { command: 'feedback', description: 'Anonymous consumer feedback' },
    { command: 'earnings', description: 'Earnings and payout status' },
    { command: 'share', description: 'Share public profile and session links' },
    { command: 'readiness', description: 'Check public booking readiness' },
