  ...
  template: `
    <section class="page">
      <header class="hero">
        ...
        <p class="muted">All alerts and updates for your staff account.</p>
      </header>
...
export class NotificationsInboxPage {
  ...
  readonly inboxConfig = computed(() => ({
    apiBase: environment.apiUrl,
    tokenKey: AUTH_TOKEN_KEY,
    apiPath: this.auth.isStoreSession()
      ? CROSS_APP_API_PATHS.STORE_NOTIFICATIONS
      : CROSS_APP_API_PATHS.NOTIFICATIONS
  }));
}
